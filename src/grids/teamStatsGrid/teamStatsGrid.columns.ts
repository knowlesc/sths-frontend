...
export function teamStatsGridColumns(): ColumnDef[] {
  return [
    { fieldName: 'Name', sortable: 'asc', width: 140, wrap: true },
    ...
    { fieldName: 'GFPG', sortable: 'desc', centered: true, headerTitle: 'GF/G' },
    { fieldName: 'GAPG', sortable: 'desc', centered: true, headerTitle: 'GA/G' },
